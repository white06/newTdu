...
//	filePath="C:/wamp/www/xuexiao/";
	...
	Introduce=[];
	InNum=0;
	var fisID="26be71d7-d3ca-4f21-abe5-99f8ff0cb98c";
...
$(function(){
	...
	$.ajax({
		...
		success:function(data){
			showUrl('content/cz/lilun.php','理论基础');
			adminNum=data;
			//getNav();
		}
	});
	...
	$(".childrenspan").on("mouseover",function(){
			...
			$(".childrenspan").on("mouseout",function(){
			 ...
			 $(".childrenspan").on("click",function(){
				 ...
				 $($(".childrenspan")[0].previousSibling)[0].src="img/ico/zhanshi01.png";
				 $($(".childrenspan")[1].previousSibling)[0].src="img/ico/zhanshi02.png";
				 $($(".childrenspan")[2].previousSibling)[0].src="img/ico/zhanshi03.png";
				 $($(".childrenspan")[3].previousSibling)[0].src="img/ico/zhanshi04.png";
...
//load加载页面
function show_2(url,fisID,content){
	console.log("3");
	var testBody=$("#contentDiv");
	testBody.empty();
	$("#contentDiv").load(url,{"KnowledgesFisId":fisID});		
	$("#nowAddress")[0].innerText=content;
}
...
function showRoom(sence,auto)
{
	...
	switch(sence)
	{
		...
		case "zhuanxianxiang":
			if(auto=="adc"){
				customname="砖铣箱空心轴自动拆";
				
			}else if(auto=="zdz"){
				customname="砖铣箱空心轴自动装"
			}else if(auto=="z"){
				customname="砖铣箱空心轴手动拆"
			}else{
				customname="砖铣箱空心轴手动装"
			}
		case "hzjjdj":
			if(auto=="adc"){
				customname="护罩进给电机自动拆";
				
			}else if(auto=="zdz"){
				customname="护罩进给电机自动装"
			}else if(auto=="z"){
				customname="护罩进给电机手动拆"
			}else{
				customname="护罩进给电机手动装"
			}
		case "chetouhuzhao":
			if(auto=="adc"){
				customname="车头护罩自动拆";
...
function GetRoomList(roomType){
	...
	$.ajax({
		...
		success:function(res){
			console.log(res)
			var xianshi='<div><div class="CreateRoom" onclick="CreateRooms(\'房间-'+roomType+'\',\''+roomType+'\')">创建房间</div>'+
					'<div style="width:230px;float:right;position:relative;bottom:30px">'+
						'房间名: &nbsp;&nbsp<input id="roomName" type="text" />'+
					'</div>'+
					'<div id="operationMode" style="width:100px;height:40px;float:right;position:relative;bottom:30px;">'+
						'<input type="radio" name="mode" value="watch"/>观看'+
						'<input type="radio" name="mode" value="operation"/>操作'+
					'</div>'+
				'</div>'+
...
function openRoom(roomType,id,type){
	...
	switch(roomType)
	{
		...
		case "尾架手动装":
			...
			break;
		case "机床部自动拆":
			showUrl('content/fangzhen/jichuangbuzdc.php')
			break;
		case "机床部自动装":
			showUrl('content/fangzhen/jichuangbuzdz.php')
			break;
		case "机床部手动拆":
			showUrl('content/fangzhen/jichuangbuc.php')
			break;
		case "机床部手动装":
			showUrl('content/fangzhen/jichuangbuz.php')
			break;
		case "拖板箱部自动拆":
			showUrl('content/fangzhen/tuobanxiangbuzdc.php')
			break;
		case "拖板箱自动装":
			showUrl('content/fangzhen/tuobanxiangbuzdz.php')
			break;
		case "拖板箱手动拆":
			showUrl('content/fangzhen/tuobanxiangbuc.php')
			break;
		case "拖板箱手动装":
			showUrl('content/fangzhen/tuobanxiangbuz.php')
			break;
		case "砖铣箱空心轴自动拆":
			showUrl('content/fangzhen/zhuanxianxiangzdc.php')
			break;
		case "砖铣箱空心轴自动装":
			showUrl('content/fangzhen/zhuanxianxiangzdz.php')
			break;
		case "砖铣箱空心轴手动装":
			showUrl('content/fangzhen/zhuanxianxiangz.php')
			break;
		case "砖铣箱空心轴手动拆":
			showUrl('content/fangzhen/zhuanxianxiangc.php')
			break;
		case "护罩进给电机自动拆":
			showUrl('content/fangzhen/huzhaodianjizdc.php')
			break;
		case "护罩进给电机自动装":
			showUrl('content/fangzhen/huzhaodianjizdz.php')
			break;
		case "护罩进给电机手动拆":
			showUrl('content/fangzhen/huzhaodianjic.php')
			break;
		case "护罩进给电机手动装":
			showUrl('content/fangzhen/huzhaodianjiz.php')
			break;
		case "车头护罩自动拆":
			showUrl('content/fangzhen/chetouhuzhaozdc.php')
			break;
		case "车头护罩自动装":
			showUrl('content/fangzhen/chetouhuzhaozdz.php')
			break;
		case "车头护罩手动拆":
			showUrl('content/fangzhen/chetouhuzhaoc.php')
			break;
		case "车头护罩手动装":
			showUrl('content/fangzhen/chetouhuzhaoz.php')
			break;
	}
}
function openRoom2(roomType){
	...
	switch(roomType){
		...
		case "尾架手动装":
			...
			showUrl('content/fangzhen/weijiaz.php')
			break;
		//added by pgc at 2018/7/8-----------------------Start
		//开启机床部的网页
		case '机床部自动拆':
			roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5357c';
			showUrl('content/fangzhen/jichuangbuzdc.php');
			break;
		case '机床部自动装':
			roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5357d';
			showUrl('content/fangzhen/jichuangbuzdz.php');
			break;
		case '机床部手动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5357e';
            showUrl('content/fangzhen/jichuangbuc.php');
            break;
        case '机床部手动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5351b';
            showUrl('content/fangzhen/jichuangbuz.php');
            break;
		//开启托板箱部的网页
		case '拖板箱部自动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5352b';
            showUrl('content/fangzhen/tuobanxiangbuzdc.php');
			break;
		case '拖板箱部自动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5353b';
            showUrl('content/fangzhen/tuobanxiangbuzdz.php');
			break;
		case '拖板箱部手动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5354b';
            showUrl('content/fangzhen/tuobanxiangbuc.php');
			break;
		case '拖板箱部手动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5355b';
            showUrl('content/fangzhen/tuobanxiangbuz.php');
			break;
		//开启砖纤箱空心轴
        case '砖铁箱自动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5356b';
            showUrl('content/fangzhen/zhuanxianxiangzdc.php');
            break;
        case '砖铁箱自动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5357b';
            ...
            break;
        case '砖铁箱手动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5358b';
            showUrl('content/fangzhen/zhuanxianxiangc.php');
            break;
        case '砖铁箱手动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5359b';
            showUrl('content/fangzhen/zhuanxianxiangz.php');
            break;
		//开启护罩点击
        case '护罩进给电机自动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5316b';
            showUrl('content/fangzhen/huzhaodianjizdc.php');
            break;
        case '护罩进给电机自动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5327b';
            showUrl('content/fangzhen/huzhaodianjizdz.php');
            break;
        case '护罩进给电机手动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5338b';
            showUrl('content/fangzhen/huzhaodianjic.php');
            break;
        case '护罩进给电机手动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e5349b';
            showUrl('content/fangzhen/huzhaodianjiz.php');
            break;
		//开启车头护罩
        case '车头护罩自动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e3e1316b';
            showUrl('content/fangzhen/chetouhuzhaozdc.php');
            break;
        case '车头护罩自动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e315327b';
            showUrl('content/fangzhen/chetouhuzhaozdz.php');
            break;
        case '车头护罩手动拆':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e325338b';
            showUrl('content/fangzhen/chetouhuzhaoc.php');
            break;
        case '车头护罩手动装':
            roomid='a47efa07-a96c-48ce-aa3d-8c39e355349b';
            showUrl('content/fangzhen/chetouhuzhaoz.php');
            break;
        //added by pgc at 2018/7/8-----------------------End
        case '测试':
        roomid='a47efa07-a96c-48ce-aa3d-8c39e355349b';
        showUrl('content/fangzhen/test.php');
        break;
	}
}