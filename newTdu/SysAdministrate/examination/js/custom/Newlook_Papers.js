				...
				if(data[i].questionType == "单选题") {
					...
					if(data[i].optionB != null && data[i].optionB.length != 0) {
						var optionB = '<li class="option">' +
							...
							'id="' + i + '_answer_' + i + '_option_2"' + data[i].id + '\')" value="B" disabled="disabled"/>' +
					...
					var input = '<input type="text" class="tiankong" name="' + i + '_blanks_' + i + '" readonly>';
		...
		if(data[i].questionType == "单选题") {
			...
			if(data[i].optionB != null && data[i].optionB.length != 0) {
				var optionB = '<li class="option">' +
					...
					'id="' + nownum + "" + i + '_answer_' + i + '_option_2"' + data[i].id + '\')" value="B" disabled="disabled"/>' +
			...
			var input = '<input type="text" class="tiankong" name="' + nownum + "" + i + '_blanks_' + i + '" readonly>';
