...
function choosesmajor(id) {
    ...
    $.ajax({
        ...
        data : {"id":id},
        success : function(data) {
            html+='    <div onclick="addmajor(\''+id+'\')" style="background:rgba(30,37,54,1);width:280px;height:400px;margin-top: 30px;margin-left: 30px;display: inline-block;position: relative;cursor:pointer">\n' +
