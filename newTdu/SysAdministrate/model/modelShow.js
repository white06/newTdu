		...
		var imgurl="http://tdu.tduvr.club/Data/3D/Model/";
			...
			doGetObjects();
                ...
                $("#insertTree").attr({ onclick: "window.location='insert.html?subModelId=" + index_i+"'" });
		...
		function doGetObjects(){
			...
			//固定测试
        	//index_id = "59d74fb8-6571-4668-95f9-a7e856d03736";
...
function create(modelId,str){
	window.location='create.html?subModelId=' + modelId+"&name="+str;
