    		...
    		$.ajax({
                ...
                xhr: function() {
                    ...
                    xhr.upload.addEventListener('progress', function (e) {
                        ...
                        processbar.innerHTML = parseInt(progressRate)+"%";
                        //通过设置进度条的宽度达到效果
                        $('#processbar').css('width', progressRate);
                    })
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == "ok") {
                        ...
                        $.post(houtaiurl+"AddKnowledgeController/AddSimulateModel.action", data =
                            { simulate: $("#urladdress").val(), KnowledgeId: $("#saveTreeNode").val(),
                                name: $("#simulname").val(),treeId:$("#sourcetree").val(),simulType:$("#simulType").val() }, function (data) {
                        	//更新数据，刷新界面
