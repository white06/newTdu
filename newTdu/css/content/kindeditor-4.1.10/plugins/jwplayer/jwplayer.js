    ...
    embed.download = function(_container, _options, _errorCallback) {
        ...
        function _styleElements() {
            ...
            _badCss(_prefix + 'icon', {
                /*jshint maxlen:9000*/
                background: 'center no-repeat url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAgCAYAAAA1zNleAAAAD0lEQVQoU2NgGAWjADcAAAIgAAEeEYatAAAAAElFTkSuQmCC)'
            });
