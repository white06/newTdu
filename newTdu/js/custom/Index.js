...
function getSceneEditor(sceneContentId, userKey, type) {
    sceneContentId = Base64.encode(sceneContentId);
    userKey = Base64.encode(userKey);
    //window.open("http://192.168.0.19:8080/index.html?sceneContentId="+sceneContentId+"&userKey="+userKey);
    window.open("https://tdu.tduvr.club/TduWebEdit/index.html?sceneContentId=" + sceneContentId + "&userKey=" + userKey);
}
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].sceneContentId == "00000000-0000-0000-0000-000000000000") {
                    ...
                    html += '        <div style="background:rgba(30,37,54,1);width:280px;height:400px;margin-top: 40px;margin-left: 40px;display: inline-block;position: relative">\n' +
                        ...
                        '                <div style="width: 23.5%;display: inline-block;text-align: center;cursor:pointer" onclick="getSceneEditor(\'' + data[i].sceneContentId + '\',\'' + data[i].userKey + '\',\'' + 1 + '\')"><img src="img/ico/icon_ffehg.png" height="38" width="38" title="编辑器"/></div>\n' +
