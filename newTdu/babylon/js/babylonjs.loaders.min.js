...
!function (e, t) {
    ...
    return function (e) {
        ...
        var r = n(0), o = n(2), a = function () {
            ...
            function e(e) {
                this._completePromises = new Array, this._forAssetContainer = !1, this._babylonLights = [], this._disposed = !1, this._state = null, this._extensions = new Array, this._defaultBabylonMaterialData = {}, this._requests = new Array, this._parent = e
            }

            return e.RegisterExtension = function (t, n) {
                e.UnregisterExtension(t) && r.Logger.Warn("Extension with the name '" + t + "' already exists"), e._RegisteredExtensions[t] = {factory: n}
                ...
                if (!this._disposed) {
                    ...
                    for (var n in this._requests.length = 0, this._completePromises.length = 0, this._extensions) {
                        var r = this._extensions[n];
                        r.dispose && r.dispose(), delete this._extensions[n]
                    }
                ...
                return Promise.resolve().then((function () {
                    s._babylonScene = t, s._rootUrl = o, s._fileName = i || "scene", s._progressCallback = a, s._forAssetContainer = n, s._loadData(r);
                    var l = null;
                    if (e) {
                        var u = {};
                        if (s._gltf.nodes)for (var c = 0, f = s._gltf.nodes; c < f.length; c++) {
                            var d = f[c];
                            d.name && (u[d.name] = d.index)
                        }
                        l = (e instanceof Array ? e : [e]).map((function (e) {
                            var t = u[e];
                            if (void 0 === t)throw new Error("Failed to find node '" + e + "'");
                            return t
                        }))
                    }
                    return s._loadAsync(l, (function () {
                        return {
                            meshes: s._getMeshes(),
                            particleSystems: [],
                ...
                return Promise.resolve().then((function () {
                    ...
                    var i = o.GLTFLoaderState[o.GLTFLoaderState.LOADING] + " => " + o.GLTFLoaderState[o.GLTFLoaderState.READY], s = o.GLTFLoaderState[o.GLTFLoaderState.LOADING] + " => " + o.GLTFLoaderState[o.GLTFLoaderState.COMPLETE];
                    ...
                    var l = new Array, u = n._babylonScene.blockMaterialDirtyMechanism;
                ...
                if (this._gltf.extensionsRequired)for (var e = function (e) {
                ...
                if (this.logOpen(e + " " + (t.name || "")), t.nodes)for (var i = 0, s = t.nodes; i < s.length; i++) {
                    var l = s[i], u = a.Get(e + "/nodes/" + l, this._gltf.nodes, l);
                    o.push(this.loadNodeAsync("/nodes/" + u.index, u, (function (e) {
                        e.parent = n._rootBabylonMesh
                    })))
                }
                if (this._gltf.nodes)for (var c = 0, f = this._gltf.nodes; c < f.length; c++) {
                    if ((u = f[c])._babylonTransformNode && u._babylonBones)for (var d = 0, h = u._babylonBones; d < h.length; d++) {
                ...
                var e = new Array, t = this._gltf.nodes;
                if (t)for (var n = 0, r = t; n < r.length; n++) {
                    var o = r[n];
                ...
                var e = new Array, t = this._gltf.skins;
                if (t)for (var n = 0, r = t; n < r.length; n++) {
                    var o = r[n];
                ...
                var e = new Array, t = this._gltf.animations;
                if (t)for (var n = 0, r = t; n < r.length; n++) {
                    var o = r[n];
                ...
                var u = function (r) {
                    ...
                    if (n.children)for (var u = 0, c = n.children; u < c.length; u++) {
                        var f = c[u], d = a.Get(t + "/children/" + f, i._gltf.nodes, f);
                ...
                var u = this, c = this._extensionsLoadMeshPrimitiveAsync(t, n, o, i, s, l);
                if (c)return c;
                this.logOpen("" + t);
                var f, d, h = this._parent.createInstances && null == o.skin && !i.primitives[0].targets;
                if (h && s._instanceData) f = s._instanceData.babylonSourceMesh.createInstance(n), d = s._instanceData.promise; else {
                    var p = new Array;
                    ...
                    d = Promise.all(p), h && (s._instanceData = {babylonSourceMesh: _, promise: d}), f = _
                }
                ...
                var o = this, i = this._extensionsLoadVertexDataAsync(e, t, n);
                if (i)return i;
                var s = t.attributes;
                if (!s)throw new Error(e + ": Attributes are missing");
                var l = new Array, u = new r.Geometry(n.name, this._babylonScene);
                ...
                var f = function (t, i, c) {
                    if (null != s[t]) {
                        n._delayInfo = n._delayInfo || [], -1 === n._delayInfo.indexOf(i) && n._delayInfo.push(i);
                        var f = a.Get(e + "/attributes/" + t, o._gltf.accessors, s[t]);
                        l.push(o._loadVertexAccessorAsync("/accessors/" + f.index, f, i).then((function (e) {
                            u.setVerticesBuffer(e, f.count)
                        }))), i == r.VertexBuffer.MatricesIndicesExtraKind && (n.numBoneInfluencers = 8), c && c(f)
                    }
                };
                return f("POSITION", r.VertexBuffer.PositionKind), f("NORMAL", r.VertexBuffer.NormalKind), f("TANGENT", r.VertexBuffer.TangentKind), f("TEXCOORD_0", r.VertexBuffer.UVKind), f("TEXCOORD_1", r.VertexBuffer.UV2Kind), f("JOINTS_0", r.VertexBuffer.MatricesIndicesKind), f("WEIGHTS_0", r.VertexBuffer.MatricesWeightsKind), f("JOINTS_1", r.VertexBuffer.MatricesIndicesExtraKind), f("WEIGHTS_1", r.VertexBuffer.MatricesWeightsExtraKind), f("COLOR_0", r.VertexBuffer.ColorKind, (function (e) {
                ...
                if (o.targets) {
                    ...
                    for (var s = 0; s < o.targets.length; s++) {
                        var l = t.weights ? t.weights[s] : n.weights ? n.weights[s] : 0, u = i ? i[s] : "morphTarget" + s;
                ...
                var i = this, s = new Array, l = function (r, o, l) {
                    if (null != n[r]) {
                ...
                if (null == e.skin) {
                    var n = r.Vector3.Zero(), o = r.Quaternion.Identity(), a = r.Vector3.One();
                ...
                var o = this, a = this._extensionsLoadSkinAsync(e, t, n);
                if (a)return a;
                var i = function (e) {
                ...
                return n._data = {babylonSkeleton: l, promise: u}, u
            }, e.prototype._loadBones = function (e, t, n) {
                for (var r = {}, o = 0, i = t.joints; o < i.length; o++) {
                    var s = i[o], l = a.Get(e + "/joints/" + s, this._gltf.nodes, s);
                ...
                for (var n = 0, o = e.bones; n < o.length; n++) {
                    var a = o[n], i = r.Matrix.Identity(), s = a._index;
                ...
                switch (this._babylonScene._blockEntityCollection = !1, s.rotation = new r.Vector3(0, Math.PI, 0), n.type) {
                    case"perspective":
                        var l = n.perspective;
                ...
                return this._loadAnimationSamplerAsync(t + "/samplers/" + o.sampler, c).then((function (t) {
                    ...
                    switch (t.interpolation) {
                        case"STEP":
                            f = function (e) {
                                return {frame: t.input[e], value: c(), interpolation: r.AnimationKeyInterpolation.STEP}
                            };
                            break;
                        case"LINEAR":
                            f = function (e) {
                                return {frame: t.input[e], value: c()}
                            };
                            break;
                        case"CUBICSPLINE":
                            f = function (e) {
                                return {frame: t.input[e], inTangent: c(), value: c(), outTangent: c()}
                            }
                    }
                    for (var h = new Array(t.input.length), p = 0; p < t.input.length; p++)h[p] = f(p);
                    if ("influence" === n)for (var _ = function (e) {
                        var t = i.name + "_channel" + i.targetedAnimations.length, o = new r.Animation(t, n, 1, a);
                        o.setKeys(h.map((function (t) {
                            ...
                            var n = t.morphTargetManager.getTarget(e), r = o.clone();
                            n.animations.push(r), i.addTargetedAnimation(r, n)
                        }))
                    }, m = 0; m < u._numMorphTargets; m++)_(m); else {
                        var y = i.name + "_channel" + i.targetedAnimations.length, b = new r.Animation(y, n, 1, a);
                ...
                var r = a.Get(e + "/input", this._gltf.accessors, t.input), o = a.Get(e + "/output", this._gltf.accessors, t.output);
                return t._data = Promise.all([this._loadFloatAccessorAsync("/accessors/" + r.index, r), this._loadFloatAccessorAsync("/accessors/" + o.index, o)]).then((function (e) {
                    var t = e[0], r = e[1];
                    return {input: t, interpolation: n, output: r}
                })), t._data
                ...
                var s = e._GetNumComponents(t, n.type), l = s * r.VertexBuffer.GetTypeByteLength(n.componentType), u = s * n.count;
                ...
                if (n.sparse) {
                    ...
                    n._data = n._data.then((function (u) {
                        var c = u, d = a.Get(t + "/sparse/indices/bufferView", i._gltf.bufferViews, f.indices.bufferView), h = a.Get(t + "/sparse/values/bufferView", i._gltf.bufferViews, f.values.bufferView);
                        return Promise.all([i.loadBufferViewAsync("/bufferViews/" + d.index, d), i.loadBufferViewAsync("/bufferViews/" + h.index, h)]).then((function (a) {
                            var i, u = a[0], d = a[1], h = e._GetTypedArray(t + "/sparse/indices", f.indices.componentType, u, f.indices.byteOffset, f.count), p = s * f.count;
                            if (5126 !== n.componentType || n.normalized) {
                                var _ = e._GetTypedArray(t + "/sparse/values", n.componentType, d, f.values.byteOffset, p);
                                i = new o(p), r.VertexBuffer.ForEach(_, 0, l, s, n.componentType, i.length, n.normalized || !1, (function (e, t) {
                                    i[t] = e
                                }))
                            } else i = e._GetTypedArray(t + "/sparse/values", n.componentType, d, f.values.byteOffset, p);
                            for (var m = 0, y = 0; y < h.length; y++)for (var b = h[y] * s, v = 0; v < s; v++)c[b++] = i[m++];
                            return c
                        }))
                    }))
                }
                ...
                var s = a.Get(t + "/index", this._gltf.textures, n.index), l = this._loadTextureAsync("/textures/" + n.index, s, (function (a) {
                ...
                if (o)return o;
                this.logOpen(t + " " + (n.name || ""));
                var i = null == n.sampler ? e.DefaultSampler : a.Get(t + "/sampler", this._gltf.samplers, n.sampler), s = a.Get(t + "/source", this._gltf.images, n.source), l = this._createTextureAsync(t, i, s, r);
                return this.logClose(), l
            }, e.prototype._createTextureAsync = function (e, t, n, o) {
                var a = this;
                void 0 === o && (o = function () {
                });
                var i = this._loadSampler("/samplers/" + t.index, t), s = new Array, l = new r.Deferred;
                this._babylonScene._blockEntityCollection = this._forAssetContainer;
                var u = new r.Texture(null, this._babylonScene, i.noMipMaps, !1, i.samplingMode, (function () {
                    a._disposed || l.resolve()
                }), (function (t, n) {
                    a._disposed || l.reject(new Error(e + ": " + (n && n.message ? n.message : t || "Failed to load texture")))
                }), void 0, void 0, void 0, n.mimeType);
                return this._babylonScene._blockEntityCollection = !1, s.push(l.promise), s.push(this.loadImageAsync("/images/" + n.index, n).then((function (e) {
                    var t = n.uri || a._fileName + "#image" + n.index, r = "data:" + a._uniqueRootUrl + t;
                    u.updateURL(r, e)
                }))), u.wrapU = i.wrapU, u.wrapV = i.wrapV, o(u), Promise.all(s).then((function () {
                    return u
                }))
                ...
                var i = this, s = this._extensionsLoadUriAsync(t, n, a);
                if (s)return s;
                ...
                var n = e.metadata = e.metadata || {}, r = n.gltf = n.gltf || {};
                ...
                var n = null == t.magFilter ? 9729 : t.magFilter, o = null == t.minFilter ? 9987 : t.minFilter;
                if (9729 === n)switch (o) {
                    case 9728:
            ...
            },e._RegisteredExtensions = {},e.DefaultSampler = {index: -1},e
        }();
        ...
        var l = function () {
            function e() {
                this.onParsedObservable = new i.Observable, this.coordinateSystemMode = r.AUTO, this.animationStartMode = o.FIRST, this.compileMaterials = !1, this.useClipPlane = !1, this.compileShadowGenerators = !1, this.transparencyAsCoverage = !1, this.useRangeRequests = !1, this.createInstances = !0, this.preprocessUrlAsync = function (e) {
            ...
            return Object.defineProperty(e.prototype, "onParsed", {
                        ...
                        var l = new Array, u = {
                            ...
                            readAsync: function (n, o) {
                                return new Promise((function (a, i) {
                                    l.push(e._requestFile(t, (function (e, t) {
                                        var n = t.getResponseHeader("Content-Range");
                                        n && (c.byteLength = Number(n.split("/")[1])), a(new Uint8Array(e))
                                    }), r, !0, !0, (function (e) {
                                        i(e)
                                    }), (function (e) {
                                        e.setRequestHeader("Range", "bytes=" + n + "-" + (n + o - 1))
                                    })))
                                }))
                            }, byteLength: 0
                        };
                        return this._unpackBinaryAsync(new i.DataReader(c)).then((function (e) {
                            u.onCompleteObservable.notifyObservers(u), n(e)
                        }), a), u
                    }
                    return e._requestFile(t, (function (e, t) {
                        var r = e;
                ...
                return e._requestFile(t, (function (r, o) {
                    s._validate(e, r, i.Tools.GetFolderPath(t), i.Tools.GetFilename(t)), n({json: s._parseJson(r)}, o)
                }), r, !0, !1, a)
                ...
                var a = {1: e._CreateGLTF1Loader, 2: e._CreateGLTF2Loader}[r.major];
                ...
                var o = t - e.byteOffset, a = {json: this._parseJson(e.readString(n)), bin: null};
                if (0 !== o) {
                    var i = e.byteOffset;
                    a.bin = {
                ...
                var n = this, r = 1313821514, o = 5130562, a = e.readUint32();
                if (e.readUint32() !== r)throw new Error("First chunk format is not JSON");
                return e.byteOffset + a === t ? e.loadAsync(a).then((function () {
                    return {json: n._parseJson(e.readString(a)), bin: null}
                })) : e.loadAsync(a + 8).then((function () {
                    var i = {json: n._parseJson(e.readString(a)), bin: null}, s = function () {
                        var n = e.readUint32();
                        switch (e.readUint32()) {
                            case r:
            ...
            }, e.IncrementalLoading = !0, e.HomogeneousCoordinates = !1, e._logSpaces = "                                ", e
        }();
                    ...
                    case"validate":
                        o(n.data, n.rootUrl, n.fileName, (function (t) {
                            return new Promise((function (n, r) {
                                var o = e.length;
                                e.push({resolve: n, reject: r}), postMessage({
        ...
        var i = function () {
            ...
            return e.ValidateAsync = function (e, t, n, i) {
                ...
                return "function" == typeof Worker ? new Promise((function (l, u) {
                    var c = o + "(" + a + ")()", f = URL.createObjectURL(new Blob([c], {type: "application/javascript"})), d = new Worker(f), h = function (e) {
                        d.removeEventListener("error", h), d.removeEventListener("message", p), u(e)
                    }, p = function (e) {
                        var t = e.data;
                        switch (t.id) {
                            case"getExternalResource":
                                i(t.uri).then((function (e) {
                                    d.postMessage({id: "getExternalResource.resolve", index: t.index, value: e}, [e])
                                }), (function (e) {
                                    d.postMessage({id: "getExternalResource.reject", index: t.index, reason: e})
                                }));
                                break;
                            case"validate.resolve":
                                d.removeEventListener("error", h), d.removeEventListener("message", p), l(t.value);
                                break;
                            case"validate.reject":
                                d.removeEventListener("error", h), d.removeEventListener("message", p), u(t.reason)
                        }
                    };
                    d.addEventListener("error", h), d.addEventListener("message", p), d.postMessage({
                        id: "init",
                        url: r.Tools.GetAbsoluteUrl(s.Configuration.url)
                    }), d.postMessage({id: "validate", data: e, rootUrl: t, fileName: n})
            ...
            }, e.Configuration = {url: "https://preview.babylonjs.com/gltf_validator.js"}, e
        }()
    }, function (e, t) {
        var n;
        n = function () {
                ...
                if (!t._loaded) {
                    ...
                    for (var i = new Array(t.specularImages.length), s = function (n) {
                        ...
                        for (var s = function (t) {
                            ...
                            l._loader.logOpen("" + s);
                            var u = r[t], c = o.a.Get(s, l._loader.gltf.images, u);
                    ...
                    this._loader.logClose(), t._loaded = Promise.all(a).then((function () {
                        ...
                        var s = r.SphericalPolynomial.FromHarmonics(a), l = (i.length - 1) / r.Scalar.Log2(t.specularImageSize);
        ...
        var s = function () {
            ...
            return e.prototype.dispose = function () {
                ...
                return o.b.LoadExtensionAsync(e, t, this.name, (function (e, i) {
                    return a._loader.loadNodeAsync("#/nodes/" + t.index, t, (function (s) {
                        var l = new Array, u = null, c = function (t, n) {
                            if (null != i.attributes[t]) {
                                var r = o.a.Get(e + "/attributes/" + t, a._loader.gltf.accessors, i.attributes[t]);
                                if (null === u) u = r.count; else if (u !== r.count)throw new Error(e + "/attributes: Instance buffer accessors do not have the same count.");
                                l.push(a._loader._loadFloatAccessorAsync("/accessors/" + r.bufferView, r).then((function (e) {
                                    n(e)
                                })))
                            }
                        }, f = null, d = null, h = null;
                        return c("TRANSLATION", (function (e) {
                            f = e
                            ...
                            if (u)for (var e = "", o = null, a = u.toString().length, i = 0; i < u; ++i)if (t._primitiveBabylonMeshes)for (var l = 0; l < t._primitiveBabylonMeshes.length; ++l) {
                                var c = t._primitiveBabylonMeshes[l];
                                e = (c.name || c.id) + "_" + r.StringTools.PadNumber(i, a), c.isAnInstance ? o = c.sourceMesh.createInstance(e) : c.createInstance && (o = c.createInstance(e)), o && (o.setParent(c), f ? r.Vector3.FromArrayToRef(f, 3 * i, o.position) : o.position.set(0, 0, 0), d ? r.Quaternion.FromArrayToRef(d, 4 * i, o.rotationQuaternion) : o.rotationQuaternion.set(0, 0, 0, 1), h ? r.Vector3.FromArrayToRef(h, 3 * i, o.scaling) : o.scaling.set(1, 1, 1))
                            }
                            return n(s), s
                        }))
                    }))
            ...
            return e.prototype.dispose = function () {
                ...
                return o.b.LoadExtensionAsync(e, t, this.name, (function (i, s) {
                    return a._loader.loadNodeAsync(e, t, (function (e) {
                        var t, l = o.a.Get(i, a._lights, s.light), c = l.name || e.name;
        ...
        var h = function () {
            ...
            return e.prototype.dispose = function () {
                ...
                if (!(n instanceof r.PBRMaterial))throw new Error(e + ": Material type not supported");
                var o = new Array;
                return n.clearCoat.isEnabled = !0, null != t.clearcoatFactor ? n.clearCoat.intensity = t.clearcoatFactor : n.clearCoat.intensity = 0, t.clearcoatTexture && o.push(this._loader.loadTextureInfoAsync(e + "/clearcoatTexture", t.clearcoatTexture, (function (e) {
                    e.name = n.name + " (ClearCoat Intensity)", n.clearCoat.texture = e
                }))), null != t.clearcoatRoughnessFactor ? n.clearCoat.roughness = t.clearcoatRoughnessFactor : n.clearCoat.roughness = 0, t.clearcoatRoughnessTexture && o.push(this._loader.loadTextureInfoAsync(e + "/clearcoatRoughnessTexture", t.clearcoatRoughnessTexture, (function (e) {
                    e.name = n.name + " (ClearCoat Roughness)", n.clearCoat.texture = e
                }))), t.clearcoatNormalTexture && (o.push(this._loader.loadTextureInfoAsync(e + "/clearcoatNormalTexture", t.clearcoatNormalTexture, (function (e) {
        ...
        var p = function () {
            ...
            return e.prototype.dispose = function () {
                ...
                if (!(n instanceof r.PBRMaterial))throw new Error(e + ": Material type not supported");
                var o = new Array;
                return n.sheen.isEnabled = !0, null != t.intensityFactor ? n.sheen.intensity = t.intensityFactor : n.sheen.intensity = 0, null != t.colorFactor && (n.sheen.color = r.Color3.FromArray(t.colorFactor)), t.colorIntensityTexture && o.push(this._loader.loadTextureInfoAsync(e + "/sheenTexture", t.colorIntensityTexture, (function (e) {
                    e.name = n.name + " (Sheen Intensity)", n.sheen.texture = e
                }))), void 0 !== t.roughnessFactor ? n.sheen.roughness = t.roughnessFactor : n.sheen.roughness = 0, n.sheen.albedoScaling = !0, Promise.all(o).then((function () {
                }))
            }, e
        }();
        ...
        var _ = function () {
            ...
            return e.prototype.dispose = function () {
                ...
                if (!(n instanceof r.PBRMaterial))throw new Error(e + ": Material type not supported");
                var o = new Array;
                return void 0 !== t.specularFactor && (n.metallicF0Factor = t.specularFactor), void 0 !== t.specularColorFactor && (n.metallicReflectanceColor = r.Color3.FromArray(t.specularColorFactor)), t.specularTexture && o.push(this._loader.loadTextureInfoAsync(e + "/specularTexture", t.specularTexture, (function (e) {
        ...
        var b = function () {
            ...
            return e.prototype.dispose = function () {
                ...
                return o.b.LoadExtensionAsync(e, t, this.name, (function (a, i) {
                    var s = null == t.sampler ? o.b.DefaultSampler : o.a.Get(e + "/sampler", r._loader.gltf.samplers, t.sampler), l = o.a.Get(a + "/source", r._loader.gltf.images, i.source);
            ...
            return e.prototype.dispose = function () {
                ...
                return o.b.LoadExtensionAsync(e, t, this.name, (function (r, a) {
                    ...
                    for (var s = 0, l = a.emitters; s < l.length; s++) {
                        var u = l[s], c = o.a.Get(r + "/emitters", n._emitters, u);
                ...
                if (t._babylonSounds = t._babylonSounds || [], !t._babylonData) {
                    for (var a = new Array, i = t.name || "emitter" + t.index, s = {
                        ...
                        var l = "#/extensions/" + u.name + "/clips", c = o.a.Get(l, u._clips, t.clips[e].clip);
                ...
                var l = i.targetedAnimations[0], u = a.emitter, c = o.a.Get("#/extensions/" + this.name + "/emitters", this._emitters, u);
        ...
        var g = function () {
            ...
            return e.prototype.dispose = function () {
                delete this._loader, this._nodeIndexLOD = null, this._nodeSignalLODs.length = 0, this._nodePromiseLODs.length = 0, this._materialIndexLOD = null, this._materialSignalLODs.length = 0, this._materialPromiseLODs.length = 0, this._indexLOD = null, this._bufferLODs.length = 0, this.onMaterialLODsLoadedObservable.clear(), this.onNodeLODsLoadedObservable.clear()
                ...
                for (r = 1; r < this._bufferLODs.length; r++)this._loadBufferLOD(r)
            }, e.prototype.loadSceneAsync = function (e, t) {
                ...
                return o.b.LoadExtensionAsync(e, t, this.name, (function (e, n) {
                    ...
                    for (var s = function (e) {
                        var t = i[e];
                        a._indexLOD = e, 0 !== e && (a._nodeIndexLOD = e, a._nodeSignalLODs[e] = a._nodeSignalLODs[e] || new r.Deferred);
                        ...
                        0 === e ? o = n : a._nodeIndexLOD = null, a._indexLOD = null, a._nodePromiseLODs[e] = a._nodePromiseLODs[e] || [], a._nodePromiseLODs[e].push(n)
                    }, l = 0; l < i.length; l++)s(l);
                    return a._loader.logClose(), o
                }))
            }, e.prototype._loadMaterialAsync = function (e, t, n, r, a) {
                var i = this;
                return this._indexLOD ? null : o.b.LoadExtensionAsync(e, t, this.name, (function (e, o) {
                    var s, l = i._getLODs(e, t, i._loader.gltf.materials, o.ids);
                    i._loader.logOpen("" + e);
                    for (var u = function (e) {
                        var t = l[e];
                        i._indexLOD = e, 0 !== e && (i._materialIndexLOD = e);
                        ...
                        0 === e ? s = o : i._materialIndexLOD = null, i._indexLOD = null, i._materialPromiseLODs[e] = i._materialPromiseLODs[e] || [], i._materialPromiseLODs[e].push(o)
                ...
                if (this._loader.parent.useRangeRequests && !t.uri) {
                    ...
                    var a = this._indexLOD || 0, i = n, s = i + o - 1, l = this._bufferLODs[a];
                    return l ? (l.start = Math.min(l.start, i), l.end = Math.max(l.end, s)) : (l = {
                        start: i,
                        end: s,
                        loaded: new r.Deferred
                    }, this._bufferLODs[a] = l), l.loaded.promise.then((function (e) {
                        return new Uint8Array(e.buffer, e.byteOffset + n - l.start, o)
                    }))
                }
                return null
            }, e.prototype._loadBufferLOD = function (e) {
                var t = this._bufferLODs[e];
                this._loader.bin.readAsync(t.start, t.end - t.start + 1).then((function (e) {
                    t.loaded.resolve(e)
                }), (function (e) {
                    t.loaded.reject(e)
                }))
                ...
                for (var a = new Array, i = r.length - 1; i >= 0; i--)if (a.push(o.a.Get(e + "/ids/" + r[i], n, r[i])), a.length === this.maxLODsToLoad)return a;
                return a.push(t), a
            }, e.prototype._disposeTransformNode = function (e) {
                var t = this, n = new Array, r = e.material;
                r && n.push(r);
        ...
        var y = function () {
            ...
            return e.prototype.getNextToken = function () {
                ...
                if (this.currentString = this.read(), this.currentToken = h.UNKNOWN, "_" === this.currentString || this.isLetterOrDigitPattern.test(this.currentString))for (this.currentToken = h.IDENTIFIER, this.currentIdentifier = this.currentString; !this.isEnd() && (this.isLetterOrDigitPattern.test(this.currentString = this.peek()) || "_" === this.currentString);)this.currentIdentifier += this.currentString, this.forward();
        ...
        }(), b = ["MODEL", "VIEW", "PROJECTION", "MODELVIEW", "MODELVIEWPROJECTION", "JOINTMATRIX"], v = ["world", "view", "projection", "worldView", "worldViewProjection", "mBones"], A = ["translation", "rotation", "scale"], g = ["position", "rotationQuaternion", "scaling"], T = function (e, t, n) {
            for (var r in e) {
                var o = e[r];
                n[t][r] = o
            }
            ...
            if (e.translation || e.rotation || e.scale) {
                var n = p.Vector3.FromArray(e.scale || [1, 1, 1]), r = p.Quaternion.FromArray(e.rotation || [0, 0, 0, 1]), o = p.Vector3.FromArray(e.translation || [0, 0, 0]);
                ...
                if (s.jointName) {
                    ...
                    for (o = 0; o < l.length; o++) {
                        ...
                        if (u.jointName && u.jointName === n) {
                            var c = L(s), f = new p.Bone(s.name || "", r, O(e, t, s.jointName, r), c);
                            return f.id = i, f
                        }
                    }
                }
            ...
            for (var n = 0; n < e.length; n++)for (var r = e[n], o = 0; o < r.node.children.length; o++) {
                if (r.node.children[o] === t)return r.bone
            }
            return null
        }, S = function (e, t) {
            var n = e.nodes, r = n[t];
            if (r)return {node: r, id: t};
            for (var o in n)if ((r = n[o]).jointName === t)return {node: r, id: o};
            return null
        }, w = function (e, t) {
            ...
            !function (e, t, n, r) {
                for (var o in e.nodes) {
                    ...
                    if (a.jointName && !w(n, a.jointName)) {
                        var s = L(a), l = new p.Bone(a.name || "", t, null, s);
                        l.id = i, r.push({bone: l, node: a, id: i})
                    }
                }
                for (var u = 0; u < r.length; u++)for (var c = r[u], f = c.node.children, d = 0; d < f.length; d++) {
                    for (var h = null, _ = 0; _ < r.length; _++)if (r[_].id === f[d]) {
                        h = r[_];
                        break
                    }
                ...
                if (A = S(e, t.jointNames[s])) {
                    ...
                    if (l) {
                        ...
                        if (u) r.bones.push(u); else {
                            ...
                            var b = L(l);
                            !f && a.length > 0 && (f = M(a, o)) && -1 === i.indexOf(f) && i.push(f), new p.Bone(l.jointName || "", r, f, b).id = o
                        }
            ...
            for (s = 0; s < t.jointNames.length; s++) {
                var A;
                if (A = S(e, t.jointNames[s]))for (d = 0; d < v.length; d++)if (v[d].id === A.id) {
                    r.bones.push(v[d]);
                    break
                }
            }
            ...
            if (o || (e.scene._blockEntityCollection = e.forAssetContainer, o = new p.Mesh(t.name || "", e.scene), e.scene._blockEntityCollection = !1, o.id = r), !t.babylonNode)return o;
            for (var a, i = [], s = null, l = new Array, u = new Array, c = new Array, f = new Array, d = 0; d < n.length; d++) {
                var h = n[d];
                if (R = e.meshes[h])for (var y = 0; y < R.primitives.length; y++) {
                    var b = new p.VertexData, v = R.primitives[y];
                    v.mode;
                    var A = v.attributes, g = null, T = null;
                    for (var E in A)if (g = e.accessors[A[E]], T = _.GetBufferFromAccessor(e, g), "NORMAL" === E) b.normals = new Float32Array(T.length), b.normals.set(T); else if ("POSITION" === E) {
                        if (m.GLTFFileLoader.HomogeneousCoordinates) {
                            b.positions = new Float32Array(T.length - T.length / 4);
                            for (var L = 0; L < T.length; L += 4)b.positions[L] = T[L], b.positions[L + 1] = T[L + 1], b.positions[L + 2] = T[L + 2]
                        } else b.positions = new Float32Array(T.length), b.positions.set(T);
                        u.push(b.positions.length)
                    } else if (-1 !== E.indexOf("TEXCOORD_")) {
                        var O = Number(E.split("_")[1]), M = p.VertexBuffer.UVKind + (0 === O ? "" : O + 1), S = new Float32Array(T.length);
                        S.set(T), x(S), b.set(S, M)
                    } else"JOINT" === E ? (b.matricesIndices = new Float32Array(T.length), b.matricesIndices.set(T)) : "WEIGHT" === E ? (b.matricesWeights = new Float32Array(T.length), b.matricesWeights.set(T)) : "COLOR" === E && (b.colors = new Float32Array(T.length), b.colors.set(T));
                    if (g = e.accessors[v.indices]) T = _.GetBufferFromAccessor(e, g), b.indices = new Int32Array(T.length), b.indices.set(T), f.push(b.indices.length); else {
                        var w = [];
                        for (L = 0; L < b.positions.length / 3; L++)w.push(L);
                        b.indices = new Int32Array(w), f.push(b.indices.length)
                    }
                    s ? s.merge(b) : s = b;
                    var C = e.scene.getMaterialByID(v.material);
                    i.push(null === C ? _.GetDefaultMaterial(e.scene) : C), l.push(0 === l.length ? 0 : l[l.length - 1] + u[u.length - 2]), c.push(0 === c.length ? 0 : c[c.length - 1] + f[f.length - 2])
                }
            }
            e.scene._blockEntityCollection = e.forAssetContainer, i.length > 1 ? (a = new p.MultiMaterial("multimat" + r, e.scene)).subMaterials = i : a = new p.StandardMaterial("multimat" + r, e.scene), 1 === i.length && (a = i[0]), o.material || (o.material = a), new p.Geometry(r, e.scene, s, !1, o), o.computeWorldMatrix(!0), e.scene._blockEntityCollection = !1, o.subMeshes = [];
            var N = 0;
            for (d = 0; d < n.length; d++) {
                var R;
                h = n[d];
                if (R = e.meshes[h])for (y = 0; y < R.primitives.length; y++)R.primitives[y].mode, p.SubMesh.AddToMesh(N, l[N], u[N], c[N], f[N], o, o, !0), N++
            }
            return o
        }, R = function (e, t, n, r) {
            ...
            if (t.skin) {
                if (t.meshes) {
                    ...
                    (i = N(e, t, t.meshes, n, t.babylonNode)).skeleton = e.scene.getLastSkeletonByID(t.skin), null === i.skeleton && (i.skeleton = C(e, a, 0, a.babylonSkeleton, t.skin), a.babylonSkeleton || (a.babylonSkeleton = i.skeleton)), o = i
                }
            } else if (t.meshes) {
                var i;
                o = i = N(e, t, t.mesh ? [t.mesh] : t.meshes, n, t.babylonNode)
                ...
                if (t.camera && !t.babylonNode && !e.importOnlyMeshes) {
                    ...
                    if (s) {
                        if (e.scene._blockEntityCollection = e.forAssetContainer, "orthographic" === s.type) {
                            ...
                            l.name = t.name || "", l.mode = p.Camera.ORTHOGRAPHIC_CAMERA, l.attachControl(e.scene.getEngine().getInputElement()), o = l
                        } else if ("perspective" === s.type) {
                            var u = s[s.type], c = new p.FreeCamera(t.camera, p.Vector3.Zero(), e.scene, !1);
                            c.name = t.name || "", c.attachControl(e.scene.getEngine().getInputElement()), u.aspectRatio || (u.aspectRatio = e.scene.getEngine().getRenderWidth() / e.scene.getEngine().getRenderHeight()), u.znear && u.zfar && (c.maxZ = u.zfar, c.minZ = u.znear), o = c
                        }
                ...
                if (f)if ("ambient" === f.type) {
                    var d = f[f.type], h = new p.HemisphericLight(t.light, p.Vector3.Zero(), e.scene);
                    h.name = t.name || "", d.color && (h.diffuse = p.Color3.FromArray(d.color)), o = h
                } else if ("directional" === f.type) {
                    var _ = f[f.type], m = new p.DirectionalLight(t.light, p.Vector3.Zero(), e.scene);
                    m.name = t.name || "", _.color && (m.diffuse = p.Color3.FromArray(_.color)), o = m
                } else if ("point" === f.type) {
                    var y = f[f.type], b = new p.PointLight(t.light, p.Vector3.Zero(), e.scene);
                    b.name = t.name || "", y.color && (b.diffuse = p.Color3.FromArray(y.color)), o = b
                } else if ("spot" === f.type) {
                    var v = f[f.type], A = new p.SpotLight(t.light, p.Vector3.Zero(), p.Vector3.Zero(), 0, 0, e.scene);
                    A.name = t.name || "", v.color && (A.diffuse = p.Color3.FromArray(v.color)), v.fallOfAngle && (A.angle = v.fallOfAngle), v.fallOffExponent && (A.exponent = v.fallOffExponent), o = A
                }
            }
            if (!t.jointName) {
                ...
                if (null === o) {
                    ...
                    e.scene._blockEntityCollection = !1, t.babylonNode = g, o = g
                }
            }
            if (null !== o) {
                if (t.matrix && o instanceof p.Mesh) !function (e, t, n) {
                    if (t.matrix) {
                        var r = new p.Vector3(0, 0, 0), o = new p.Quaternion, a = new p.Vector3(0, 0, 0);
                        p.Matrix.FromArray(t.matrix).decompose(a, o, r), R(e, r, o, a)
                    } else t.translation && t.rotation && t.scale && R(e, p.Vector3.FromArray(t.translation), p.Quaternion.FromArray(t.rotation), p.Vector3.FromArray(t.scale));
                    e.computeWorldMatrix(!0)
                }(o, t); else {
                    var T = t.translation || [0, 0, 0], x = t.rotation || [0, 0, 0, 1], E = t.scale || [1, 1, 1];
                    R(o, p.Vector3.FromArray(T), p.Quaternion.FromArray(x), p.Vector3.FromArray(E))
                }
            ...
            if (r = !(e.importOnlyMeshes && !r && e.importMeshesNames) || (-1 !== e.importMeshesNames.indexOf(o.name || "") || 0 === e.importMeshesNames.length), !o.jointName && r && null !== (a = P(e, o, t)) && (a.id = t, a.parent = n), o.children)for (var i = 0; i < o.children.length; i++)I(e, o.children[i], a, r)
        }, F = function (e) {
            var t = e.currentScene;
            if (t)for (var n = 0; n < t.nodes.length; n++)I(e, t.nodes[n], null); else for (var r in e.scenes) {
                t = e.scenes[r];
                for (n = 0; n < t.nodes.length; n++)I(e, t.nodes[n], null)
            }
            !function (e) {
                for (var t in e.animations) {
                    ...
                    if (n.channels && n.samplers)for (var r = null, o = 0; o < n.channels.length; o++) {
                        ...
                        if (i) {
                            ...
                            var u = _.GetBufferFromAccessor(e, e.accessors[s]), c = _.GetBufferFromAccessor(e, e.accessors[l]), f = a.target.id, d = e.scene.getNodeByID(f);
                            if (null === d && (d = e.scene.getNodeByName(f)), null !== d) {
                                var h = d instanceof p.Bone, m = a.target.path, y = A.indexOf(m);
                                -1 !== y && (m = g[y]);
                                var b = p.Animation.ANIMATIONTYPE_MATRIX;
                                h || ("rotationQuaternion" === m ? (b = p.Animation.ANIMATIONTYPE_QUATERNION, d.rotationQuaternion = new p.Quaternion) : b = p.Animation.ANIMATIONTYPE_VECTOR3);
                                var v = null, T = [], x = 0, E = !1;
                                h && r && r.getKeys().length === u.length && (v = r, E = !0), E || (e.scene._blockEntityCollection = e.forAssetContainer, v = new p.Animation(t, h ? "_matrix" : m, 1, b, p.Animation.ANIMATIONLOOPMODE_CYCLE), e.scene._blockEntityCollection = !1);
                                for (var L = 0; L < u.length; L++) {
                                    var O = null;
                                    if ("rotationQuaternion" === m ? (O = p.Quaternion.FromArray([c[x], c[x + 1], c[x + 2], c[x + 3]]), x += 4) : (O = p.Vector3.FromArray([c[x], c[x + 1], c[x + 2]]), x += 3), h) {
                                        var M = d, S = p.Vector3.Zero(), w = new p.Quaternion, C = p.Vector3.Zero(), N = M.getBaseMatrix();
                                        E && r && (N = r.getKeys()[L].value), N.decompose(C, w, S), "position" === m ? S = O : "rotationQuaternion" === m ? w = O : C = O, O = p.Matrix.Compose(C, w, S)
                                    }
                                    E ? r && (r.getKeys()[L].value = O) : T.push({frame: u[L], value: O})
                                }
                                !E && v && (v.setKeys(T), d.animations.push(v)), r = v, e.scene.stopAnimation(d), e.scene.beginAnimation(d, 0, u[u.length - 1], !0, 1)
            ...
            return function (i) {
                !function (e, t, n, r, o) {
                    var a = r.values || n.parameters, i = n.uniforms;
                    for (var l in o) {
                        var u = o[l], c = u.type, f = a[i[l]];
                        if (void 0 === f && (f = u.value), f) {
                            ...
                            c === s.SAMPLER_2D ? k.LoadTextureAsync(e, r.values ? f : u.value, d(l), (function () {
                                return d(null)
                            })) : u.value && _.SetUniform(t, l, r.values ? f : u.value, c) && delete o[l]
                        }
                    }
                    ...
                    !function (e, t, n, r, o, a, i) {
                        ...
                        for (var u in n) {
                            var c = n[u], f = c.type;
                            if (f === s.FLOAT_MAT2 || f === s.FLOAT_MAT3 || f === s.FLOAT_MAT4)if (!c.semantic || c.source || c.node) {
                                if (c.semantic && (c.source || c.node)) {
                                    ...
                                    _.SetMatrix(t.scene, d, c, u, r.getEffect())
                                }
                            } else _.SetMatrix(t.scene, e, c, u, r.getEffect()); else {
                                ...
                                } else _.SetUniform(r.getEffect(), u, h, f)
                            }
                        }
                        i(r)
                    }(i, e, o, t, n, r, a)
            ...
            for (var r in t.uniforms) {
                ...
                if (e.currentIdentifier === r && a.semantic && !a.source && !a.node) {
                    var i = b.indexOf(a.semantic);
                    if (-1 !== i)return delete n[r], v[i]
                }
            }
            return e.currentIdentifier
        }, D = function (e) {
            for (var t in e.materials)k.LoadMaterialAsync(e, t, (function (e) {
            }), (function () {
            }))
        }, G = function () {
            function e() {
            ...
            return e.CreateRuntime = function (e, t, n) {
                ...
                var o = e.textures[t];
                if (o && o.source)if (o.babylonTexture) n(null); else {
                ...
                if (a.babylonTexture) r(a.babylonTexture); else {
                    var i = e.samplers[a.sampler], s = i.minFilter === u.NEAREST_MIPMAP_NEAREST || i.minFilter === u.NEAREST_MIPMAP_LINEAR || i.minFilter === u.LINEAR_MIPMAP_NEAREST || i.minFilter === u.LINEAR_MIPMAP_LINEAR, l = p.Texture.BILINEAR_SAMPLINGMODE, c = null == n ? new Blob : new Blob([n]), f = URL.createObjectURL(c), d = function () {
                        return URL.revokeObjectURL(f)
                    }, h = new p.Texture(f, e.scene, !s, !0, l, d, d);
                    void 0 !== i.wrapS && (h.wrapU = _.GetWrapMode(i.wrapS)), void 0 !== i.wrapT && (h.wrapV = _.GetWrapMode(i.wrapT)), h.name = t, a.babylonTexture = h, r(h)
                }
                ...
                if (o.technique) {
                    ...
                    if (!a) {
                        ...
                        return e.scene._blockEntityCollection = !1, i.diffuseColor = new p.Color3(.5, .5, .5), i.sideOrientation = p.Material.CounterClockWiseSideOrientation, void n(i)
                    }
                    var l = e.programs[a.program], u = a.states, c = p.Effect.ShadersStore[l.vertexShader + "VertexShader"], _ = p.Effect.ShadersStore[l.fragmentShader + "PixelShader"], m = "", A = "", g = new y(c), T = new y(_), x = {}, L = [], O = [], M = [];
                    for (var S in a.uniforms) {
                        var w = a.uniforms[S], C = a.parameters[w];
                        if (x[S] = C, !C.semantic || C.node || C.source) C.type === s.SAMPLER_2D ? M.push(S) : L.push(S); else {
                            var N = b.indexOf(C.semantic);
                            -1 !== N ? (L.push(v[N]), delete x[S]) : L.push(S)
                        }
                    }
                    for (var R in a.attributes) {
                        var P = a.attributes[R];
                        if ((D = a.parameters[P]).semantic) {
                            var I = E(D);
                            I && O.push(I)
                        }
                    }
                    for (; !g.isEnd() && g.getNextToken();) {
                        if (g.currentToken === h.IDENTIFIER) {
                            ...
                            for (var R in a.attributes) {
                                P = a.attributes[R];
                                var D = a.parameters[P];
                                if (g.currentIdentifier === R && D.semantic) {
                                    m += E(D), F = !0;
                                    break
                                }
                            }
                            F || (m += B(g, a, x))
                        } else m += g.currentString
                    }
                    for (; !T.isEnd() && T.getNextToken();) {
                        T.currentToken === h.IDENTIFIER ? A += B(T, a, x) : A += T.currentString
                    }
                    var G = {vertex: l.vertexShader + t, fragment: l.fragmentShader + t}, U = {
                        attributes: O,
                        uniforms: L,
                        samplers: M,
                        needAlphaBlending: u && u.enable && -1 !== u.enable.indexOf(3042)
                    };
                    p.Effect.ShadersStore[l.vertexShader + t + "VertexShader"] = m, p.Effect.ShadersStore[l.fragmentShader + t + "PixelShader"] = A;
                    ...
                    if (k.onError = function (e, t, n) {
                        ...
                        }(l, k, r), k.onCompiled = V(e, k, a, o, x, n), k.sideOrientation = p.Material.CounterClockWiseSideOrientation, u && u.functions) {
                        var H = u.functions;
                        H.cullFace && H.cullFace[0] !== f.BACK && (k.backFaceCulling = !1);
                        var j = H.blendFuncSeparate;
                        j && (j[0] === d.SRC_ALPHA && j[1] === d.ONE_MINUS_SRC_ALPHA && j[2] === d.ONE && j[3] === d.ONE ? k.alphaMode = p.Constants.ALPHA_COMBINE : j[0] === d.ONE && j[1] === d.ONE && j[2] === d.ZERO && j[3] === d.ONE ? k.alphaMode = p.Constants.ALPHA_ONEONE : j[0] === d.SRC_ALPHA && j[1] === d.ONE && j[2] === d.ZERO && j[3] === d.ONE ? k.alphaMode = p.Constants.ALPHA_ADD : j[0] === d.ZERO && j[1] === d.ONE_MINUS_SRC_COLOR && j[2] === d.ONE && j[3] === d.ONE ? k.alphaMode = p.Constants.ALPHA_SUBTRACT : j[0] === d.DST_COLOR && j[1] === d.ZERO && j[2] === d.ONE && j[3] === d.ONE ? k.alphaMode = p.Constants.ALPHA_MULTIPLY : j[0] === d.SRC_ALPHA && j[1] === d.ONE_MINUS_SRC_COLOR && j[2] === d.ONE && j[3] === d.ONE && (k.alphaMode = p.Constants.ALPHA_MAXIMIZED))
                    }
            ...
            return e.RegisterExtension = function (t) {
                ...
                return t.useRightHandedSystem = !0, k.LoadRuntimeAsync(t, n, r, (function (t) {
                    t.forAssetContainer = o, t.importOnlyMeshes = !0, "" === e ? t.importMeshesNames = [] : "string" == typeof e ? t.importMeshesNames = [e] : !e || e instanceof Array ? (t.importMeshesNames = [], p.Tools.Warn("Argument meshesNames must be of type string or string[]")) : t.importMeshesNames = [e], l._createNodes(t);
                    var n = new Array, r = new Array;
                    for (var s in t.nodes) {
                        var u = t.nodes[s];
                        u.babylonNode instanceof p.AbstractMesh && n.push(u.babylonNode)
                    }
                    for (var c in t.skins) {
                        var f = t.skins[c];
                        f.babylonSkeleton instanceof p.Skeleton && r.push(f.babylonSkeleton)
                    }
                    l._loadBuffersAsync(t, (function () {
                        l._loadShadersAsync(t, (function () {
                            D(t), F(t), !m.GLTFFileLoader.IncrementalLoading && a && a(n, r)
                        }))
                    }), i), m.GLTFFileLoader.IncrementalLoading && a && a(n, r)
                }), s), !0
            }, e.prototype.importMeshAsync = function (e, t, n, r, o, a) {
                var i = this;
                    ...
                    k.LoadRuntimeExtensionsAsync(e, (function () {
                        s._createNodes(e), s._loadBuffersAsync(e, (function () {
                            s._loadShadersAsync(e, (function () {
                                D(e), F(e), m.GLTFFileLoader.IncrementalLoading || o()
                            }))
                        })), m.GLTFFileLoader.IncrementalLoading && o()
                    }), i)
                }), i)
        ...
        m.GLTFFileLoader._CreateGLTF1Loader = function () {
            return new U
        };
        var H = function (e) {
            function t() {
            ...
            return o(t, e), t.prototype.loadRuntimeAsync = function (e, t, n, r, o) {
                ...
                var o = e.textures[t], i = e.images[o.source];
                if (!i.extensions || !(this.name in i.extensions))return !1;
                var s = i.extensions[this.name], l = e.bufferViews[s.bufferView];
                return n(_.GetBufferFromBufferView(e, l, 0, l.byteLength, a.UNSIGNED_BYTE)), !0
            }, t.prototype.loadShaderStringAsync = function (e, t, n, r) {
                var o = e.shaders[t];
                if (!o.extensions || !(this.name in o.extensions))return !1;
                var i = o.extensions[this.name], s = e.bufferViews[i.bufferView], l = _.GetBufferFromBufferView(e, s, 0, s.byteLength, a.UNSIGNED_BYTE);
                return setTimeout((function () {
                    var e = _.DecodeBufferToText(l);
                    n(e)
                })), !0
            }, t
        }(k);
        U.RegisterExtension(new H);
        var j = function (e) {
            function t() {
            ...
            return o(t, e), t.prototype.loadRuntimeExtensionsAsync = function (e, t, n) {
                ...
                if (o)for (var a in o) {
                    ...
                    switch (i.type) {
                        case"ambient":
                            var s = new p.HemisphericLight(i.name, new p.Vector3(0, 1, 0), e.scene), l = i.ambient;
                            l && (s.diffuse = p.Color3.FromArray(l.color || [1, 1, 1]));
                            break;
                        case"point":
                            var u = new p.PointLight(i.name, new p.Vector3(10, 10, 10), e.scene), c = i.point;
                            c && (u.diffuse = p.Color3.FromArray(c.color || [1, 1, 1]));
                            break;
                        case"directional":
                            var f = new p.DirectionalLight(i.name, new p.Vector3(0, -1, 0), e.scene), d = i.directional;
        ...
        var r = n(0), o = function () {
            ...
            return Object.defineProperty(e, "INVERT_TEXTURE_Y", {
                ...
                return this._parseSolid(e, t, n, r).then((function (e) {
                    return {meshes: e, particleSystems: [], skeletons: [], animationGroups: []}
                }))
            }, e.prototype.loadAsync = function (e, t, n, r, o) {
                ...
                for (var s, l = this, u = [], c = [], f = [], d = [], h = [], p = [], _ = [], m = [], y = [], b = [], v = [], A = 0, g = !1, T = [], x = [], E = [], L = [], O = [], M = "", S = "", w = new o, C = 1, N = !0, R = new r.Color4(.5, .5, .5, 1), P = function (e, t, n, r, o, a, i) {
                    var s;
                    -1 === (s = l._meshLoadOptions.OptimizeWithUV ? function (e, t) {
                        e[t[0]] || (e[t[0]] = {normals: [], idx: [], uv: []});
                        var n = e[t[0]].normals.indexOf(t[1]);
                        return 1 != n && t[2] === e[t[0]].uv[n] ? e[t[0]].idx[n] : -1
                    }(v, [e, n, t]) : function (e, t) {
                        e[t[0]] || (e[t[0]] = {normals: [], idx: []});
                        var n = e[t[0]].normals.indexOf(t[1]);
                        return -1 === n ? -1 : e[t[0]].idx[n]
                    }(v, [e, n])) ? (p.push(_.length), _.push(r), m.push(o), b.push(a), void 0 !== i && y.push(i), v[e].normals.push(n), v[e].idx.push(A++), l._meshLoadOptions.OptimizeWithUV && v[e].uv.push(t)) : p.push(s)
                }, I = function () {
                    for (var e = 0; e < _.length; e++)T.push(_[e].x, _[e].y, _[e].z), E.push(b[e].x, b[e].y, b[e].z), L.push(m[e].x, m[e].y);
                    !0 === l._meshLoadOptions.ImportVertexColors && x.push(y[e].r, y[e].g, y[e].b, y[e].a), _ = [], b = [], m = [], y = [], v = [], A = 0
                }, F = function (e, t) {
                    ...
                    for (var n = 0; n < O.length; n++) {
                        ...
                        P(o, 0, 0, u[o], r.Vector2.Zero(), r.Vector3.Up(), !0 === l._meshLoadOptions.ImportVertexColors ? d[o] : void 0)
                    }
                    O = []
                }, B = function (e, t) {
                    F(e, t);
                    for (var n = 0; n < O.length; n++) {
                        var o = O[n].split("/"), a = parseInt(o[0]) - 1, i = parseInt(o[1]) - 1;
                        P(a, i, 0, u[a], f[i], r.Vector3.Up(), !0 === l._meshLoadOptions.ImportVertexColors ? d[a] : void 0)
                    }
                    O = []
                }, D = function (e, t) {
                    F(e, t);
                    for (var n = 0; n < O.length; n++) {
                        var r = O[n].split("/"), o = parseInt(r[0]) - 1, a = parseInt(r[1]) - 1, i = parseInt(r[2]) - 1;
                        P(o, a, i, u[o], f[a], c[i])
                    }
                    O = []
                }, G = function (e, t) {
                    ...
                    for (var n = 0; n < O.length; n++) {
                        var o = O[n].split("//"), a = parseInt(o[0]) - 1, i = parseInt(o[1]) - 1;
                        P(a, 1, i, u[a], r.Vector2.Zero(), c[i], !0 === l._meshLoadOptions.ImportVertexColors ? d[a] : void 0)
                    }
                    O = []
                }, U = function (e, t) {
                    F(e, t);
                    for (var n = 0; n < O.length; n++) {
                        var r = O[n].split("/"), o = u.length + parseInt(r[0]), a = f.length + parseInt(r[1]), i = c.length + parseInt(r[2]);
                        P(o, a, i, u[o], f[a], c[i], !0 === l._meshLoadOptions.ImportVertexColors ? d[o] : void 0)
                    }
                    O = []
                }, k = function () {
                    ...
                    if (0 !== W.length && "#" !== W.charAt(0))if (this.vertexPattern.test(W)) K = W.match(/[^ ]+/g), u.push(new r.Vector3(parseFloat(K[1]), parseFloat(K[2]), parseFloat(K[3]))), !0 === this._meshLoadOptions.ImportVertexColors && (K.length >= 7 ? d.push(new r.Color4(parseFloat(K[4]), parseFloat(K[5]), parseFloat(K[6]), 7 === K.length || void 0 === K[7] ? 1 : parseFloat(K[7]))) : d.push(R)); else if (null !== (K = this.normalPattern.exec(W))) c.push(new r.Vector3(parseFloat(K[1]), parseFloat(K[2]), parseFloat(K[3]))); else if (null !== (K = this.uvPattern.exec(W))) f.push(new r.Vector2(parseFloat(K[1]) * e.UV_SCALING.x, parseFloat(K[2]) * e.UV_SCALING.y)); else if (null !== (K = this.facePattern3.exec(W))) D(K[1].trim().split(" "), 1); else if (null !== (K = this.facePattern4.exec(W))) G(K[1].trim().split(" "), 1); else if (null !== (K = this.facePattern5.exec(W))) U(K[1].trim().split(" "), 1); else if (null !== (K = this.facePattern2.exec(W))) B(K[1].trim().split(" "), 1); else if (null !== (K = this.facePattern1.exec(W))) V(K[1].trim().split(" "), 1); else if (this.group.test(W) || this.obj.test(W)) {
                        ...
                        k(), h.push(Y), g = !0, N = !0, C = 1
                    } else if (this.usemtl.test(W)) {
                        if (M = W.substring(7).trim(), !N || !g) {
                            k();
                            Y = {
                                name: "mesh_mm" + C.toString(),
                                indices: void 0,
                                positions: void 0,
                                normals: void 0,
                                uvs: void 0,
                        ...
                        g && N && (h[h.length - 1].materialName = M, N = !1)
                    } else this.mtllib.test(W) ? S = W.substring(7).trim() : this.smooth.test(W) || console.log("Unhandled expression at line : " + W)
                }
                g && (s = h[h.length - 1], p.reverse(), I(), s.indices = p, s.positions = T, s.normals = E, s.uvs = L, !0 === this._meshLoadOptions.ImportVertexColors && (s.colors = x)), g || (p.reverse(), I(), h.push({
                ...
                for (var q = [], X = new Array, J = 0; J < h.length; J++) {
                    ...
                    !0 === this._meshLoadOptions.ImportVertexColors && (Z.colors = s.colors), Z.applyToMesh(Q), this._meshLoadOptions.InvertY && (Q.scaling.y *= -1), q.push(Q)
                }
                var $ = [];
                    ...
                    l._loadMTL(S, i, (function (o) {
                        try {
                            ...
                            for (var a = 0; a < w.materials.length; a++) {
                                for (var s, u = 0, c = []; (s = X.indexOf(w.materials[a].name, u)) > -1;)c.push(s), u = s + 1;
                                if (-1 === s && 0 === c.length) w.materials[a].dispose(); else for (var f = 0; f < c.length; f++)q[c[f]].material = w.materials[a]
                            }
                            e()
                        } catch (n) {
        ...
        var r = n(0), o = function () {
            ...
            return e.prototype.importMesh = function (e, t, n, o, a, i, s) {
                ...
                for (var n = t.byteLength, r = 0; r < n; r++)if (t.getUint8(r) > 127)return !0;
                return !1
                ...
                for (var n = new DataView(t), o = n.getUint32(80, !0), a = 0, i = new Float32Array(3 * o * 3), s = new Float32Array(3 * o * 3), l = new Uint32Array(3 * o), u = 0, c = 0; c < o; c++) {
                    for (var f = 84 + 50 * c, d = n.getFloat32(f, !0), h = n.getFloat32(f + 4, !0), p = n.getFloat32(f + 8, !0), _ = 1; _ <= 3; _++) {
                        var m = f + 12 * _;
                        i[a] = n.getFloat32(m, !0), i[a + 2] = n.getFloat32(m + 4, !0), i[a + 1] = n.getFloat32(m + 8, !0), s[a] = d, s[a + 2] = h, s[a + 1] = p, a += 3
                    }
                    l[u] = u++, l[u] = u++, l[u] = u++
                }
                ...
                for (var n, o = [], a = [], i = [], s = 0; n = this.facetsPattern.exec(t);) {
                    var l = n[1], u = this.normalPattern.exec(l);
        ...
        (function (e) {
            ...
            if (void 0 !== o)for (var a in o.BABYLON = o.BABYLON || {}, o.BABYLON.GLTF1 = o.BABYLON.GLTF1 || {}, r)o.BABYLON.GLTF1[a] = r[a]
        }).call(this, n(4))
    }, function (e, t, n) {
        "use strict";
        (function (e) {
            var r = n(5), o = n(11), a = n(6);
            n.d(t, "a", (function () {
                return a
            }));
        ...
        n(2), n(3), n(7), n(6), n(8), n(9);
        var r = n(10), o = n(12), a = n(13), i = n(14), s = n(15)
    }])
}));
